...
export default function BuildSection({ className = '' }: BuildSectionProps) {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // ENTRANCE (0% - 30%) - Card from right, thumbnail from left
      scrollTl.fromTo(
        cardRef.current,
  ...
  return (
    ...
    >
      ...
      <div ref={bgRef} className="absolute inset-0 w-full h-full">
        <img
          src="/manufacturing_coveralls.jpg"
          alt="Build at Prototown"
      ...
      <div
        ref={thumbnailRef}
        className="hidden lg:block absolute left-[6vw] top-1/2 -translate-y-1/2 z-10 w-[34vw] max-w-[420px] h-[62vh]"
        style={{ opacity: 0 }}
      >
        <div className="relative w-full h-full rounded-[22px] overflow-hidden">
          <img
            src="/manufacturing_assembly_thumbnail.jpg"
      ...
      <div
        ref={cardRef}
        className="absolute right-4 sm:right-6 lg:right-[6vw] top-1/2 -translate-y-1/2 z-10 w-[calc(100%-2rem)] sm:w-[44vw] max-w-[520px]"
        style={{ opacity: 0 }}
      >
        <div className="card-glass rounded-[22px] p-6 sm:p-8">
          ...
          >
            Small-batch manufacturing, clean assembly lines, and logistics
            support—so you can ship hardware like software.
          </p>
          <div ref={chipsRef} className="flex flex-wrap gap-2">
            <span className="chip-lime">Assembly</span>
            <span className="chip-lime">Logistics</span>
          </div>
        </div>
      </div>
    </section>
