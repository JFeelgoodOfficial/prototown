...
export const DIFFICULTY_PERSONALITY: Record<Difficulty, AiPersonality> = {
  relaxed: { aggression: 0.6, expansion: 0.8, economy: 0.8, research: 0.7 },
  normal: { aggression: 1, expansion: 1, economy: 1, research: 1 },
  hard: { aggression: 1.5, expansion: 1.3, economy: 1.3, research: 1.4 },
};
