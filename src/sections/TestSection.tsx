...
export default function TestSection({ className = '' }: TestSectionProps) {
  ...
  return (
    ...
    >
      ...
      <div ref={bgRef} className="absolute inset-0 w-full h-full">
        <img
          src="/range_field_dusk.jpg"
          alt="Test at Prototown"
      ...
      >
        <div className="card-glass rounded-[22px] p-6 sm:p-8">
          ...
          >
            Outdoor ranges, RF-quiet zones, and flight corridors—designed for
            drones, robotics, and controlled experiments.
          </p>
          <div ref={chipsRef} className="flex flex-wrap gap-2">
            <span className="chip-lime">Range</span>
            <span className="chip-lime">RF-quiet</span>
          </div>
        </div>
      </div>
      ...
      >
        <div className="relative w-full h-full rounded-[22px] overflow-hidden">
          <img
            src="/range_equipment_thumbnail.jpg"
            alt="Outdoor range"
            className="w-full h-full object-cover"
          />
